...
<html lang="en">
  ...
  <a class="navbar-brand"href="Home Pagelog.php">
    ...
    ?>
      ...
      <section class="TripleM" style="background-image: linear-gradient(#FFD700, #333); padding-top:1rem;">
...
<div  class="custom-select">
  ...
  <option  value="Crime">Crime</option>
        ...
        <div class="col-md-4">
          <h3>Year:</h3>
<div class="select">
  <select name="value2" id="slct" name ="Year">
    <option value="Browse.html">All</option>
    <option value="Year 19-20.html">2019-2020</option>
	<option value="Year 17-18.html">2017-2018</option>
	<option value="Year 15-16.html">2015-2016</option>
	<option value="Year 13-14.html">2013-2014</option>	
	<option value="Year Old-12.html">Old-2012</option>
...
<div class="select">
  ...
  <option value="ratingh">Highest Rating</option>
  <option value="ratingl">Lowest Rating</option>
    ...
    <input type="text " class="form-control" style="border-radius:20px;" name="search" id="name"  autocomplete="off" placeholder="Type Name"> 
        </form>
        </div>
        </div>
  </section>
...
for ($i=1; $i<=$total_pages; $i++) {?>  
 ...
 <li class="page-item" style="list-style-type: none;">
                <a href="browse.php?page=<?php echo $i++ ?>" class="page-link" aria-label="Next">
                    <span aria-hidden="true">»</span>
                </a>
            </li>
...
<div class="col-md-2">
<?php echo "<a  href='delete.php?Type=Watchlater&Place=Browse&MovieName=".$row['MovieName']."&Username=".$row['Username']."'style='text-decoration: none; color:white;'>🗙</a>" ?>
</div>
...
<div class="col-md-2">
<?php echo "<a  href='delete.php?Type=Favorites&Place=Browse&MovieName=".$row['MovieName']."&Username=".$row['Username']."'style='text-decoration: none; color:white;'>🗙</a>" ?>
</div>
<div class="col-md-12" style="font-size:15px; color:#a7a7a7">
Added on
</div>
...
<script type="text/javascript">
  document.getElementById('genre').value = "<?php echo $_POST['genre'];?>";
